...
const AddToCartButton = ({ product }) => {
    ...
    const [inCart, setInCart] = useState(cartContext.find(item => item.id === product.id) !== undefined);
    ...
    return (
    <Button sx={{width:"100%"}} variant={inCart ? "outlined" : "contained"} onClick={handleAddToCart}>
